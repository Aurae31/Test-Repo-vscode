...
#9. Toggle
st.write("*9. Toggle*")
on = st.toggle("Acvtivate feature ")
if on:
...
st.write("The number you inserted is:", number)
...
d = st.date_input(
    ...
    datetime.date(2000, 9, 14))
st.write('Your birthday is:', d)

#12. Image
st.write("*12. Image*")
link_gambar = 'https://statics.indozone.news/content/2019/11/19/vWs58L/t_5de5f0aee125b_700.jpg'
st.image(link_gambar, caption='Rumah Sakit')
